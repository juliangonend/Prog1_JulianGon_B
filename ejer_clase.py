...
#Validamos que el dia del mes no sea incorrecto
if dia_mes>31 or dia_mes<=0:
    dia_mes=int(input("Ingrese el DD nuevamenta desde el 1 al 31"))
#Validamos que el  mes no sea incorrecto
if mes>12 or mes<=0:
    mes=int(input("Ingrese el MM nuevamenta desde el 1 al 12"))
if dia_sem=="lunes":
    nivel="basico"
    print(f"Nivel {nivel}")
